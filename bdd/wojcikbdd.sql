...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 10 mai 2018 à 22:11
...
CREATE TABLE `content` (
  ...
  `date_article` varchar(20) DEFAULT NULL,
...
INSERT INTO `message` (`id_message`, `name`, `phone`, `name_message`, `content_message`, `email`) VALUES
(167, '', '', '', '', '');
...
--
ALTER TABLE `message`
  MODIFY `id_message` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=168;
